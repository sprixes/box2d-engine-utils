...
public class DynamicNinePatch extends DynamicDisplay {
	...
	/**
	 * @param texture
	 *            Texture of the ninepatch.
	 * @param width
	 *            Width of the ninepatch upon rendering.
	 * @param height
	 *            Height of the ninepatch upon rendering
	 * @param corners
	 *            MUST be a size of 4. Left, right, top, bottom, respectively.
	 **/

	public DynamicNinePatch(TextureRegion texture, float width, float height, int left, int right, int top, int bottom) {
	...
	public DynamicNinePatch(TextureRegion texture, float width, float height, int[] corners) {
